...
class HidReportEncoder {
    ...
    companion object {
        ...
        private val CONSUMER_USAGES = mapOf(
            "BRIGHTNESS_UP" to 0x006f,
            "BRIGHTNESS_DOWN" to 0x0070,
            "KEYBOARD_BRIGHTNESS_UP" to 0x0079,
            "KEYBOARD_BRIGHTNESS_DOWN" to 0x007a,
            "KEYBOARD_BACKLIGHT_MINIMUM" to 0x007d,
            "KEYBOARD_BACKLIGHT_MAXIMUM" to 0x007e,
            "PLAY" to 0x00b0,
            "PAUSE" to 0x00b1,
            "RECORD" to 0x00b2,
